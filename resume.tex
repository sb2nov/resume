...
\section{Experience}
  \begin{resumeHeadingList}
    ...
    \resumeHeading
      {\icon{img/niche.png}{https://niche/com}{4ex}{0.25}Niche}{Pittsburgh, PA}
      ...
      \resumeHeading
      {\icon{img/epic.png}{https://epic.com}{4ex}{0.25}Epic Systems}{Madison, WI}
      {Software Developer}{Jul 2018 - Dec 2019}
      \begin{resumeItemList}
        \resumeItem{Immunization Scheduling}{Module owner for a patient safety critical implementation of the CDC \href{https://www.cdc.gov/vaccines/programs/iis/cdsi.html}{CDSi} vaccine schedule guidelines. Worked with physician stakeholders to implement accurate vaccine dose forecasting system scaled to millions of Epic patients.}
        \resumeItem{SYSVAK}{Outpatient development lead for integration with Norwegian national vaccine registry.}
      \end{resumeItemList}
    
    \resumeHeading
      {\icon{img/viavi.png}{https://viavisolutions.com}{2ex}{0.15}Viavi Solutions, Inc}{Germantown, MD}
