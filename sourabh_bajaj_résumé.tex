%-------------------------
% Resume in Latex
% Author : Sourabh Bajaj, Sandeepan Sengupta
% License : MIT
%------------------------
...
\usepackage[backend= biber, style= ieee]{biblatex} %https://www.overleaf.com/learn/latex/biblatex_citation_styles
...
%-------------------------
% Custom biber commands
%-------------------------

% https://latex.org/forum/viewtopic.php?t=26618
\addbibresource{example.bib}

% Uncomment following line to mute indexing
...
%--------PUBLICATIONS------------
\printbibliography[title=Conference Proceedings, heading=bibintoc, type=inproceedings]
\printbibliography[title=Peer-reviewed Posters and Presentations, heading=bibintoc, type=booklet]
\nocite{*}
