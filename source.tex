...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Enable content validation for an ad-tech company.}
      \resumeItemListEnd
      \resumeTech{Technologies}{GCP, Python.}\\
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeTech{Technologies}{AWS, Python, Athena.}\\
    %   \resumeTech{Theory}{Machine learning, AutoML, Feature engineering, Project management.}
    \sepsection
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
      \resumeTech{Technologies}{Python, R, JS, Vue, Bash, Gephi, Power BI, REST APIs, Airflow, Tensorflow, BERT.}\\
