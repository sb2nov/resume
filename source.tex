...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Technical guide of the Data Science team (5 members).}
      \resumeItem{Improve the adaptability of the scoring API by creating 10+ features engineering stages.}
      \resumeItem{Build an AutoML service for the modeling need of the product.}
      \resumeItem{Design ML workflows for new customers processing pipelines.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItem{Tutored thesis work on AI.}
      \resumeItemListEnd
    \resumeSubSubheading
      {Teaching assistant (Introduction to Data Science, Data Mining)}{April 2015 - February 2018}
     \resumeItemListStart
      \resumeItem{Designed and organized practical course material and resources for topics described in \href{https://bit.ly/2VYchte}{here}.}
    ...
    \resumeSubheading
      ...
      \resumeItem{Improved usability of created models by creating a chrome extension connected to them.}
...
\newpage
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Reduced overload of sourcing teams by 10\% by creating an automated allocation algorithm with Linear programming and Constraing Satisfaction techniques.}
...
\section{Technical skills}
  ...
  \resumeSubItem{\textbf{Currently learning:} Vue, Nodejs.}
...
\section{Personal Projects \color{urlcolor}{(with links)}}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{\href{https://github.com/wilmeragsgh/WarmChat}{WarmChat: This app is a chat room that classify every message and say weather is an insult or not using four classifiers: svm, random forest, decision trees and max entropy.}}
