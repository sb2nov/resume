...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {CircleUp}{(remote) Caracas, VE}
      {Machine learning engineer}{August 2021 - Present}
      \resumeItemListStart
      \resumeItem{Improve ML monitoring practices.}
      \resumeItem{Enable semantic comparison of brands.}
      \resumeItem{Maintain ML pipelines.}
      \resumeItemListEnd
      \resumeTech{Technologies}{Python, Spark, AWS, Airflow, GCP.}\\
    ...
    \resumeSubheading
      ...
      {Machine learning engineer}{March 2021 - July 2021}
      \resumeItemListStart
...
\section{Certifications \color{urlcolor}{(with links)}}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\href{https://www.coursera.org/account/accomplishments/certificate/XN23WJKKJ5HZ}{Introduction to machine learning in production}}{Issued July 2021}
