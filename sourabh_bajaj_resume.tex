...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://od2.github.io/}{\Large User Name}} & Email : \href{mailto:od2@localhost}{od2@localhost}\\
  \href{http://od2.github.io/}{http://od2.github.io} & Mobile : +62 821 812 345678 \\
\end{tabular*}
...
\section{Certification}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Dataquest.io Academy}{Atlanta, GA}
      {Data Engineer Certification;  GPA: 4.00}{Aug. 2012 -- Dec. 2013}
    \resumeSubheading
      {OpenClassRooms x Dev-C FB Indonesia}{Pilani, India}
      {Frontend Development Course Certification;  GPA: 3.66 (9.15/10.0)}{Aug. 2008 -- July. 2012}
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Build XX in Medan, Sumatera Utara}
      {https://github.com/od2/XXXXX}
      \resumeItemListStart
...
%-------------------------------------------
    ...
    \resumeSubheading
      {Scrape Coursera Mountain View, CA}
      {https://github.com/od2/afsf}
      \resumeItemListStart
    ...
    \resumeSubheading
      {LAAAucena Research Atlanta, GA}
      {https://github.com/od2/lurena}
      \resumeItemListStart
...
\section{Reference}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Article About Visualization}
