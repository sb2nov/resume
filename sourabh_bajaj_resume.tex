  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Surveys}
          {Designed the internal survey/data collection system which allowed for various question types and ability to ask different questions based on learner responses. Used for onboarding, NPS etc.}
        ...
        \resumeItem{Course Dashboards}
          {Instructor dashboards and learner surveying tools, which helped instructors
