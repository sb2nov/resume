...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Systems Engineer: Core Controls}{May 2023 - Present}
      \resumeItemListStart
...
%-------------------------------------------
    ...
    \resumeSubheading
      {Diamond Light source}{Harwell Science Campus, UK}
      {Mechanical Design Engineer: Beamline Engineering}{Jan. 2019 - Feb. 2022}
      \resumeItemListStart
        \resumeItem{Tensorflow}
          {TensorFlow is an open source software library for numerical computation using data flow graphs; primarily used for training deep learning models. Worked on APIs and performance for training models on Tensor Processing Units (TPU).}
        \resumeItem{Apache Beam}
    ...
    \resumeSubheading
      ...
      {Junior mechanical engineer: Wafer Loading Systems}{Jan. 2016 - Dec. 2018}
      \resumeItemListStart
